...
//        builder.negativeButtonTextSize((int) res.getDimension(R.dimen.activity_dialog_negative_button_size));
        ...
        customDialog.setClickListener(new CustomDialog.ClickListener() {
            ...
            public void onConfirmClick() {
                Toast.makeText(getApplicationContext(), "فعلا این امکان اضافه نشده", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onCancelClick() {
                Toast.makeText(getApplicationContext(), "لغو شد", Toast.LENGTH_SHORT).show();
            }
        });
